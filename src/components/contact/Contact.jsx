...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_15tacml', 'template_9hmgfhv', formRef.current, 'xE_Y9YRlrWt5kK9xQ')
          .then((result) => {
  ...
  return (
    <motion.div ref={ref} className='contact' variants={variants} initial='initial' whileInView='animate'>
      ...
      <motion.div className="item" variants={variants}>
        <h2>Mail</h2>
        <span>suhailrazij@gmail.com</span>
      </motion.div>
      <motion.div className="item" variants={variants}>
        <h2>Address</h2>
      ...
      <div className="formContainer">
        <motion.div className="phonesvg" initial={{opacity: 1}} whileInView={{opacity: 0}} transition={{delay: 2, duration: 1}}>
            ...
            d="M13.5 2C13.5 2 15.8335 2.21213 18.8033 5.18198C21.7731 8.15183 21.9853 10.4853 21.9853 10.4853" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
            <motion.path 
            initial={{pathLength: 0}} 
            animate={isInView && { pathLength:1}}
            transition={{
